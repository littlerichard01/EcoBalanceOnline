        ...
        <div className="home-content">
          ...
          <section className="info-section">
            ...
            <details className="faq-item">
              ...
              <p>{textos[idiomaSelecionado]?.resposta3}<a style={{color: '#6e6e6e',}} href={idiomaSelecionado === 'pt' ? 'https://drive.google.com/file/d/1rubWWD99dvSLSSgZJd-fZ_V9fPF2X7La/view?usp=drive_link' : 'https://drive.google.com/file/d/1eb97rlsCiOJRbTIQfklXceAR8ys4IIBK/view?usp=drive_link'}>{textos[idiomaSelecionado]?.cliqueAqui}</a></p>
            </details>
            <details className="faq-item">
